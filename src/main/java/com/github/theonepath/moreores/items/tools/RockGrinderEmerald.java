...
public class RockGrinderEmerald extends PickaxeItem {
	private ItemStack item;
  
	public RockGrinderEmerald(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
		super(tier, attackDamageIn, attackSpeedIn, builder);
		setRegistryName("rock_grinder_emerald");
  	}
