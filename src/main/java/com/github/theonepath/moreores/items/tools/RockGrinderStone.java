...
import com.github.theonepath.moreores.lists.ToolMaterialList;
...
public class RockGrinderStone extends PickaxeItem {
	private ItemStack item;
  
	public RockGrinderStone(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
		super(tier, attackDamageIn, attackSpeedIn, builder);
		setRegistryName("rock_grinder_stone");
  	}
