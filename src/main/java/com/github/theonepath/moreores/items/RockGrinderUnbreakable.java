...
public class RockGrinderUnbreakable extends PickaxeItem {
	private ItemStack item;
  
	public RockGrinderUnbreakable(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
