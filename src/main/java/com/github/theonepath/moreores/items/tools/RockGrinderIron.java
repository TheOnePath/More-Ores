...
public class RockGrinderIron extends PickaxeItem {
	private ItemStack item;
  
	public RockGrinderIron(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
		super(tier, attackDamageIn, attackSpeedIn, builder);
		setRegistryName("rock_grinder_iron");
  	}
