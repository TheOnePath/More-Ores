...
import static com.github.theonepath.moreores.lists.BlockList.POWERBANK_CONTAINER;

public class PowerBankContainer extends Container {

    private TileEntity tileEntity;
    private PlayerEntity playerEntity;
    private IItemHandler playerInventory;

    public PowerBankContainer(int windowId, World world, BlockPos pos, PlayerInventory inventory, PlayerEntity player) {
        super(POWERBANK_CONTAINER, windowId);
