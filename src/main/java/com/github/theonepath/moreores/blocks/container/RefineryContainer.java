...
import static com.github.theonepath.moreores.lists.BlockList.REFINERY_CONTAINER;
...
public class RefineryContainer extends Container {
    ...
    public RefineryContainer(int windowId, World world, BlockPos pos, PlayerInventory inventory, PlayerEntity player) {
        super(REFINERY_CONTAINER, windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, BlockList.REFINERY);
    }
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < RefineryTileEntity.SIZE) {
                if (!this.mergeItemStack(itemstack1, RefineryTileEntity.SIZE, this.inventorySlots.size(), true)) {
                    return ItemStack.EMPTY;
                }
            } else if (!this.mergeItemStack(itemstack1, 0, RefineryTileEntity.SIZE, false)) {
                return ItemStack.EMPTY;
            }
